...
function LawyerMessages() {
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      const receiverId = caseDetails.data.client.id;
        ...
        <div className="card" style={{ overflow: 'auto' }}>
          ...
          {cases.map((c) => (
            ...
            >
              ...
              <span className={`badge badge-${c.status}`} style={{ marginTop: '5px' }}>
                {c.status}
              </span>
            </div>
          ))}
